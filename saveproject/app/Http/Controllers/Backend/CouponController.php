...

{
...

    {
        ...
        $notification = [
            ...
            'message' => 'Bon de reduction crée avec succès !!!',
...

    {
        ...
        $notification = [
            ...
            'message' => 'Bon de reduction modifié avec succès !!!',
...

    {
        ...
        $notification = [
            ...
            'message' => 'Bon de reduction supprimé  avec succès !!!',
...

    {
        ...
        return response()->json(['success'=>'Bon de reduction changé avec succès.']);
