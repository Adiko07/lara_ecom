...

{
...

    {
        ...
        return response()->json(['success' => 'Produit supprimé de votre panier'],200);
...

    {
        ...
        return response()->json(['success' => 'Quantité du produit augmentée'],200);
...

    {
        ...
        return response()->json(['error' => 'Quantité du produit diminuée'],200);
...

    {
        ...
        if ($coupon) {
            ...
            return response()->json(array(
                ...
                'success' => 'Bon de reduction appliqué avec succès'

            ));

        }else{

            return response()->json(['error' => 'Bon de reduction invalide'],200);
