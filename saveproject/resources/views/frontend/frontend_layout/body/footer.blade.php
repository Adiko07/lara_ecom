        ...
        <div class="row">
            ...
            <div class="module-body">
                ...
                <li class="media">
                    ...
                    <p>Abidjan, Yopougon, Sideci Lem</p>
                    </div>
                </li>
                <li class="media">
                ...
                <li class="media">
                    ...
                    <div class="media-body"> <span><a href="#">infosodibci@gmail.com</a></span> </div>
                </li>
                </ul>
            </div>
            <!-- /.module-body -->
            ...
            <div class="module-body">
                ...
                <li class="first"><a href="{{ route('dashboard')}}" title="Contact us">Mon compte</a></li>
                <li><a href="{{ route('user.orders')}}" title="About us">Historique de commande</a></li>
