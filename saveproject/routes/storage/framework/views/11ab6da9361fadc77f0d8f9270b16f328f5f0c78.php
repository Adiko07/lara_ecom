                    ...
                    <div class="product">
                        ...
                        <div class="action">
                            ...
                            <li class="lnk wishlist">
                                <a data-toggle="tooltip" class="add-to-cart" href="<?php echo e(route('frontend-product-details',['id' => $product->id, 'slug' => $product->product_slug_en])); ?>" title="Wishlist"> <i class="icon fa fa-heart"></i> </a>
                            </li>
...
<?php /**PATH C:\wamp64\www\lara_ecom\resources\views\frontend\frontend_layout\home_page\new-products.blade.php ENDPATH**/ ?>