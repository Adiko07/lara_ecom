        ...
        <div class="row">
                                        ...
                                        <table id="example1" class="table table-bordered table-striped dataTable"
                                            ...
                                            <tbody>
                                                ...
                                                <tr role="row" class="odd">
                                                    ...
                                                    <td class="sorting_1"><?php echo e($item->district_name); ?></td>
                                                    <td>
                                                        <div class="input-group">
                                                            <a href="<?php echo e(route('district.edit', $item)); ?>" class="btn btn-info" title="Edit Data"><i class="fa fa-pencil"></i></a>
                                                            <form action="<?php echo e(route('district.destroy', $item)); ?>" method="post">
            ...
            <div class="col-md-4 col-lg-4">
                <div class="box">
                    ...
                    <!-- /.box-header -->
                    <div class="box-body">
                        <form action="<?php echo e(route('district.store')); ?>" method="post">
                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.admin_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\lara_ecom\resources\views\admin\District\index.blade.php ENDPATH**/ ?>