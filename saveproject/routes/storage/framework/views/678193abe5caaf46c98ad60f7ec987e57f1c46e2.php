            ...
            <div class="col-md-8 col-lg-8 offset-2">
                <div class="box">
                    <div class="box-header with-border d-flex justify-content-between align-items-center">
                        ...
                        <a href="<?php echo e(route('subsubcategories.index')); ?>" class="btn btn-primary">Back List Sub Sub-Category</a>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
...
<?php echo $__env->make('admin.admin_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\lara_ecom\resources\views\admin\SubSubCategory\edit.blade.php ENDPATH**/ ?>