            ...
            <div class="col-md-12 col-lg-12">
                <div class="box">
                    <div class="box-header with-border d-flex justify-content-between align-items-center">
                        ...
                        <a href="<?php echo e(route('slider.create')); ?>" class="btn btn-primary">Nouveau caroussel</a>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
...
<?php echo $__env->make('admin.admin_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sodiicmc/public_html/resources/views/admin/Slider/index.blade.php ENDPATH**/ ?>