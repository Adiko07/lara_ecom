...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <input type="text" name="brand_name_bn" value="<?php echo e($brand->brand_name_bn); ?>" class="form-control" required="" data-validation-required-message="This field is required"> <div class="help-block"></div>
                                </div>
...
<?php echo $__env->make('admin.admin_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\lara_ecom\resources\views\admin\Brands\edit.blade.php ENDPATH**/ ?>