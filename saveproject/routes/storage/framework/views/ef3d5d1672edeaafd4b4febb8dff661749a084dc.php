            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="<?php echo e(route('invoice-download', $order->id)); ?>" class="btn btn-sm btn-danger"><i class="fa fa-download"></i>Invoice</a>
                    </td>
                </tr>
...
<?php echo $__env->make('dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\lara_ecom\resources\views\frontend\order\order-history.blade.php ENDPATH**/ ?>