...
<div class="more-info-tab clearfix ">
    ...
    <ul class="nav nav-tabs nav-tab-line pull-right" id="new-products-1">
        <li class="active"><a data-transition-type="backSlide" href="#all" data-toggle="tab">
            <?php if(session()->get('language') == 'bangla'): ?> সব <?php else: ?> Tous <?php endif; ?>
        </a></li>
...
<div class="tab-content outer-top-xs">
    <div class="tab-pane in active" id="all">
        ...
        <div class="owl-carousel home-owl-carousel custom-carousel owl-theme" data-item="6">
            ...
            <h5 class="text-danger">Aucun produit!</h5>
            <?php endif; ?>
        <!-- /.item -->
        </div>
        <!-- /.home-owl-carousel -->
...
<?php /**PATH /home/sodiicmc/public_html/resources/views/frontend/frontend_layout/home_page/new-products.blade.php ENDPATH**/ ?>