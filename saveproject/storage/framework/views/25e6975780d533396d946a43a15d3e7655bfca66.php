...
<div class="body-content">
	<div class="container">
        ...
        <div class="col-md-12 col-sm-12 sign-in m-auto">
            <h4 class="">COMPTE ADMINISTRATEUR</h4>
            ...
            <form class="register-form outer-top-xs" role="form" action="<?php echo e(route('admin_forgot.password.link')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('frontend.frontend_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sodiicmc/public_html/resources/views/auth/admin_forgot.blade.php ENDPATH**/ ?>