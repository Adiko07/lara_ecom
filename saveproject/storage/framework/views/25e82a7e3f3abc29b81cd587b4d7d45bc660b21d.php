                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                id="color">
                                                    ...
                                                    <?php $__currentLoopData = $colors_bn; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                id="size">
                                                    ...
                                                    <?php if(session()->get('langiage') == 'bangla'): ?>
                                                    <?php $__currentLoopData = $size_bn; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($item); ?>"><?php echo e(ucwords($item)); ?></option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    <?php else: ?>
...
<?php echo $__env->make('frontend.frontend_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\lara_ecom\resources\views\frontend\frontend_layout\product_page\product-page.blade.php ENDPATH**/ ?>