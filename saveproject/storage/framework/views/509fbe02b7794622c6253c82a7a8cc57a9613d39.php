            ...
            <div class="col-md-12 col-lg-12">
                ...
                <div class="box">
                    ...
                    <div class="box-header with-border d-flex justify-content-between align-items-center">
                        ...
                        <a href="<?php echo e(route('subsubcategories.create')); ?>" class="btn btn-primary">Nouvelle sous sous-catégorie</a>
                                        ...
                                        <table id="example1" class="table table-bordered table-striped dataTable"
                                            ...
                                            <tbody>
                                                ...
                                                <tr role="row" class="odd">
                                                    ...
                                                    <td class="sorting_1"><?php echo e($item->subsubcategory_name_en); ?></td>
                                                    ...
                                                    <td>
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <a href="<?php echo e(route('subsubcategories.edit', $item)); ?>" class="btn btn-info" title="Edit Data"><i class="fa fa-pencil"></i></a>

                                                            <form action="<?php echo e(route('subsubcategories.destroy', $item)); ?>" method="post">
...
<?php echo $__env->make('admin.admin_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sodiicmc/public_html/resources/views/admin/SubSubCategory/index.blade.php ENDPATH**/ ?>