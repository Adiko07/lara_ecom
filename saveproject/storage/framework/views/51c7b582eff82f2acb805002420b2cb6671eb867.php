								  ...
								  <div class="row">
									<div class="col-6">
									  <div class="checkbox text-white">
										...
										<label for="basic_checkbox_1"><?php echo e(__('Remember me')); ?></label>
									  </div>
									</div>
									<!-- /.col -->
									<div class="col-6">
									 <div class="fog-pwd text-right">
										...
										<a href="<?php echo e(route('password.request')); ?>" class="text-white hover-info"><i class="ion ion-locked"></i> <?php echo e(__('Forgot your password?')); ?></a><br>
                                        <?php endif; ?>
									  </div>
									</div>
									<!-- /.col -->
									<div class="col-12 text-center">
									  <button type="submit" class="btn btn-info btn-rounded mt-10"><?php echo e(__("SIGN IN")); ?></button>
									</div>
									<!-- /.col -->
								  </div>
							</form>														
...
<?php /**PATH C:\wamp64\www\lara_ecom\resources\views\auth\admin_login.blade.php ENDPATH**/ ?>