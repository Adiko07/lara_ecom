                    ...
                    <div class="box-body">
                        <form action="<?php echo e(route('categories.update', $category)); ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <input type="text" value="<?php echo e(old('category_name_en', $category->category_name_en)); ?>" name="category_name_en" class="form-control" required="" data-validation-required-message="Ce champs est requis"> <div class="help-block"></div>
                                </div>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <input type="text" name="category_icon" class="form-control" value="<?php echo e(old('category_icon', $category->category_icon)); ?>"> <div class="help-block"></div>
                                </div>
...
<?php echo $__env->make('admin.admin_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sodiicmc/public_html/resources/views/admin/Category/edit.blade.php ENDPATH**/ ?>