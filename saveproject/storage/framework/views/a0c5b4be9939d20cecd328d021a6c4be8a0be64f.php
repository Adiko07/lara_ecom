            ...
            <div class="col-md-8 col-lg-8 offset-2">
                <div class="box">
                    <div class="box-header with-border d-flex justify-content-between align-items-center">
                        ...
                        <a href="<?php echo e(route('coupons.index')); ?>" class="btn btn-primary">Liste des Bons de réductions</a>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
...
<?php echo $__env->make('admin.admin_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sodiicmc/public_html/resources/views/admin/Coupons/create.blade.php ENDPATH**/ ?>