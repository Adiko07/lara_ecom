                        ...
                        <div id="myTabContent" class="tab-content category-list">
                            <div class="tab-pane active" id="grid-container">
                                <div class="category-product">
                                    <div class="row">
                                        <?php $__currentLoopData = $tag_products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag_product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="col-sm-6 col-md-4 wow fadeInUp animated"
                                            style="visibility: visible; animation-name: fadeInUp;">
                                            <div class="products">
                                                <div class="product">
                                                    <div class="product-image">
                                                        <div class="image"> <a href="<?php echo e(route('frontend-product-details',['id' => $tag_product->id, 'slug' => $tag_product->product_slug_en])); ?>"><img
                                                                    src="<?php echo e(asset($tag_product->product_thumbnail)); ?>"
                                                                    alt=""></a> </div>
                                                        <!-- /.image -->
                                                    ...
                                                    ?>
                                                    <?php if($tag_product->discount_price == NULL): ?>
                                                    ...
                                                    <div class="product-info text-left">
                                                        <h3 class="name"><a href="<?php echo e(route('frontend-product-details',['id' => $tag_product->id, 'slug' => $tag_product->product_slug_en])); ?>">
                                                            <?php if(session()->get('language') == 'bangla'): ?>
                                                                <?php echo e($tag_product->product_name_bn); ?>

                                                            <?php else: ?>
                                                                <?php echo e($tag_product->product_name_en); ?>
                                                        ...
                                                        <div class="product-price">
                                                            <?php if($tag_product->discount_price == NULL): ?>
                                                            <span class="price">$<?php echo e($tag_product->selling_price); ?></span>
                                                            <?php else: ?>
                                                            <span class="price">$<?php echo e($tag_product->discount_price); ?></span>
                                                            <span class="price-before-discount">$<?php echo e($tag_product->selling_price); ?></span>
                                                            <?php endif; ?>
                                                        </div>
                                                        <!-- /.product-price -->
                                                    ...
                                                    <div class="col col-sm-8 col-lg-8">
                                                        <div class="product-info">
                                                            ...
                                                            <div class="description m-t-10">
                                                                <?php if(session()->get('language') == 'bangla'): ?>
                                                                <?php echo e($tag_product->short_description_bn); ?>

                                                                <?php else: ?>
                                                                <?php echo e($tag_product->short_description_en); ?>
...
<?php echo $__env->make('frontend.frontend_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\lara_ecom\resources\views\frontend\tags\tags_view.blade.php ENDPATH**/ ?>