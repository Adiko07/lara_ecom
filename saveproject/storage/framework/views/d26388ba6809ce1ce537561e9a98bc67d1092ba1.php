	...
	<form class="register-form outer-top-xs" role="form" action="<?php echo e(isset($guard) ? url($guard.'/login') : route('login')); ?>" method="POST">
		...
		<div class="radio outer-xs">
              ...
              <?php if(Route::has('password.request')): ?>
		  	    <a href="<?php echo e(route('password.request')); ?>" class="forgot-password pull-right">Mot de passe oublié ?</a>
              <?php endif; ?>
            </div>
...
<?php echo $__env->make('frontend.frontend_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\lara_ecom\resources\views/auth/login.blade.php ENDPATH**/ ?>